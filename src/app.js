...
function add_buttons(divid, metric_x, metric_y, better) {
	...
	select_list.append('option').attr('value', 'Download').attr('disabled', 'selected').text('Download').attr('style', 'display:none');
...
export { load_scatter_visualization, onQuartileChange, better };
